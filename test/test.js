...
describe("Vivid Log | Testing Suite", function () {
    ...
    before(function () {
        global.v = require("../dist/vividLog").default;
        global.methods = require("../dist/methods").Methods;
        global.util = require("../dist/utils").Utils;
        global.ENUM = require("../dist/enums").LogSize;
    });
